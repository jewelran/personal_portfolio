                ...
                <section className = "row d-flex justify-content-center container-fluid pt-5">
                  ...
                  <aside className ="">
                            ...
                            <big className = "text-secondary fs-2">
                                A PROFESSIONAL <span className ="text-light " ><Typical 
                                loop = {Infinity}
                                wrapper = "b"
                                steps = {[
                            ...
                            <div className="mt-5">
                          <Link to = "/contact">  <button className= "submitBtn">Hire me</button></Link>
                            </div>
                    </aside>
                  </aside>
...
export default TopHeader;<div className="row">
