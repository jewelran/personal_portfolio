...
const Navigation = () => {
  return (
    <div className="bg-dark fixed-top navContainer">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse  navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item border border-danger navBtn">
                <Link class="nav-link  text-danger" to="/skill">
                  SKILL
                </Link>
              </li>
              <li class="nav-item border border-danger navBtn">
                <Link class="nav-link  text-danger" to="/contact">
                  CONTACT
                </Link>
              </li>

              <li class="nav-item text-danger navBtn active">
                mdjewelrana6487@gmail.com <br /> +88 017-08-64-87-28
              </li>
            </ul>
          </div>
        </div>
